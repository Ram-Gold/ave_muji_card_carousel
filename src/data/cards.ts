...
export const AVE_MUJICA_CARDS: CardData[] = [
  ...
  },
  {
    ...
    characterJa: '劇団 Ave Mujica',
    characterEn: 'In Preparation · 準備中',
    role: 'Grand Arcana · ???',
    themeColor: '#eab308',
    glowColor: 'rgba(234, 179, 8, 0.45)',
    albedo: cardBack,
    normal: cardBackNormal,
    roughness: cardBackRoughness,
    back: cardBack,
    backNormal: cardBackNormal,
    backRoughness: cardBackRoughness,
    quote: '「次なる仮面は、漆黒の帳の奥に」',
    description: 'The upcoming theatrical arcana card is in preparation. Double-tap to inspect the ornate Ave Mujica seal back face.',
